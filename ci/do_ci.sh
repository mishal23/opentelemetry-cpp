...
EOF
  ...
  bazel build $BAZEL_OPTIONS -- //... -//exporters/otlp/... -//exporters/prometheus/... -//exporters/etw/...
  bazel test $BAZEL_TEST_OPTIONS -- //... -//exporters/otlp/... -//exporters/prometheus/... -//exporters/etw/...
  exit 0
  ...
  bazel build --copt=-fno-exceptions $BAZEL_OPTIONS -- //... -//exporters/prometheus/... -//exporters/etw/...
